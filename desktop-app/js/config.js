...
// ===== 连接手机 卡片定义 =====
const CHANNEL_CARDS = [
  { key: 'feishu', label: '飞书', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><defs><linearGradient id="fsg" x1="0" y1="0" x2="36" y2="36"><stop offset="0%" stop-color="#3370FF"/><stop offset="100%" stop-color="#1E4BD2"/></linearGradient></defs><rect width="36" height="36" rx="7" fill="url(#fsg)"/><path d="M9 10 C8 10 7 11 7 12.5 L7 23 C7 24.5 8 26 9.5 26 L15 26 L18 28 L21 26 L26.5 26 C28 26 29 24.5 29 23 L29 12.5 C29 11 28 10 26.5 10 Z" fill="white" opacity="0.95"/><path d="M12 15 L18 21 L24 15" fill="none" stroke="#3370FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><polygon points="18,17 23,12 13,12" fill="#3370FF" opacity="0.8"/></svg>', desc: '飞书机器人，App ID + Secret', hl: '打开飞书开发者后台→创建应用→填ID和密钥', fields: [{id:'app_id', label:'App ID', placeholder:'cli_...'}, {id:'app_secret', label:'App Secret', placeholder:'粘贴密钥'}] },
  { key: 'wecom', label: '企业微信', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><rect width="36" height="36" rx="7" fill="#07C160"/><g transform="translate(6,6)"><path d="M12 0 C5.4 0 0 4.5 0 10c0 3 1.6 5.7 4.2 7.3a.8.8 0 0 1 .28.9l-.52 1.9a.38.38 0 0 0 .37.48.4.4 0 0 0 .2-.06l2.4-1.4a1.1 1.1 0 0 1 .9-.12 13 13 0 0 0 3.6.5c3.5 0 6.5-2.2 7.4-5.2-1.1-3.3-4.6-5.6-8.6-5.6zM7.5 7c.8 0 1.5.7 1.5 1.5S8.3 10 7.5 10 6 9.3 6 8.5 6.7 7 7.5 7zm9 0c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5S15 9.3 15 8.5 15.7 7 16.5 7zM7 13.5c-2.3-.06-4.8.7-6.8 2.3C-2 17.6-3.2 20.5-2 23.7c1.2 3.1 4.7 5.4 8.8 5.4 1 0 2-.15 3-.4a.9.9 0 0 1 .8.1l2 1.2a.35.35 0 0 0 .18.06c.17 0 .3-.14.3-.3 0-.08-.03-.15-.05-.23l-.42-1.6a.75.75 0 0 1-.03-.2.63.63 0 0 1 .25-.5C16.5 25.9 17.7 23.8 17.7 21.5c0-4.1-3.7-7.5-8.5-7.8 0 0 0-.2 0-.2zm-3.2 4.2c.7 0 1.2.55 1.2 1.25a1.25 1.25 0 0 1-2.5 0c0-.7.55-1.25 1.3-1.25zm6.2 0c.7 0 1.2.55 1.2 1.25a1.25 1.25 0 0 1-2.5 0c0-.7.55-1.25 1.3-1.25z" fill="white"/></g></svg>', desc: '智能机器人·长连接，Bot ID + Secret', hl: '企微管理后台→智能机器人→API模式→填密钥', fields: [{id:'bot_id', label:'Bot ID', placeholder:'粘贴Bot ID'}, {id:'secret', label:'Secret', placeholder:'粘贴密钥'}] },
  { key: 'qq', label: 'QQ', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><rect width="36" height="36" rx="7" fill="#12B7F5"/><g transform="translate(6,6)"><path d="M21.395 15.035a40 40 0 0 0-.803-2.264l-1.079-2.695c.001-.032.014-.562.014-.836C19.526 4.632 17.351 0 12 0S4.474 4.632 4.474 9.241c0 .274.013.804.014.836l-1.08 2.695a39 39 0 0 0-.802 2.264c-1.021 3.283-.69 4.643-.438 4.673.54.065 2.103-2.472 2.103-2.472 0 1.469.756 3.387 2.394 4.771-.612.188-1.363.479-1.845.835-.434.32-.379.646-.301.778.343.578 5.883.369 7.482.189 1.6.18 7.14.389 7.483-.189.078-.132.132-.458-.301-.778-.483-.356-1.233-.646-1.846-.836 1.637-1.384 2.393-3.302 2.393-4.771 0 0 1.563 2.537 2.103 2.472.251-.03.581-1.39-.438-4.673" fill="white"/></g></svg>', desc: 'QQ开放平台机器人，AppID + Secret', hl: 'QQ开放平台创建机器人→填入ID和密钥→连上', fields: [{id:'app_id', label:'AppID', placeholder:'粘贴AppID'}, {id:'app_secret', label:'AppSecret', placeholder:'粘贴密钥'}] },
  { key: 'dingtalk', label: '钉钉', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><defs><linearGradient id="dtg" x1="0" y1="36" x2="36" y2="0"><stop offset="0%" stop-color="#0066CC"/><stop offset="100%" stop-color="#0089FF"/></linearGradient></defs><rect width="36" height="36" rx="7" fill="url(#dtg)"/><g transform="translate(7,5)"><path d="M11 0 C5 0 0 5 0 11 L0 16 C0 18.5 2 20.5 4.5 21 L7 21 L9 23 L11 21 L18.5 21 C21 21 23 18.5 23 16 L23 5.5 C23 2.5 21 0 18.5 0 Z" fill="white" opacity="0.95"/><path d="M6 10 L11 15 L16 10" fill="none" stroke="#0089FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="11" cy="7" r="2.5" fill="#0089FF"/></g></svg>', desc: '钉钉机器人，Client ID + Secret', hl: '钉钉开发者后台→创建机器人→填ID和密钥→发布', fields: [{id:'client_id', label:'Client ID', placeholder:'粘贴Client ID'}, {id:'client_secret', label:'Client Secret', placeholder:'粘贴密钥'}] }
];
