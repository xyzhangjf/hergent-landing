...
// ===== 连接手机 卡片定义 =====
const CHANNEL_CARDS = [
  { key: 'feishu', label: '飞书', icon: 'feishu-icon', desc: '飞书机器人，App ID + Secret', hl: '打开飞书开发者后台→创建应用→填ID和密钥', fields: [{id:'app_id', label:'App ID', placeholder:'cli_...'}, {id:'app_secret', label:'App Secret', placeholder:'粘贴密钥'}] },
  { key: 'wecom', label: '企业微信', icon: 'wecom-icon', desc: '智能机器人·长连接，Bot ID + Secret', hl: '企微管理后台→智能机器人→API模式→填密钥', fields: [{id:'bot_id', label:'Bot ID', placeholder:'粘贴Bot ID'}, {id:'secret', label:'Secret', placeholder:'粘贴密钥'}] },
  { key: 'qq', label: 'QQ', icon: 'qq-icon', desc: 'QQ开放平台机器人，AppID + Secret', hl: 'QQ开放平台创建机器人→填入ID和密钥→连上', fields: [{id:'app_id', label:'AppID', placeholder:'粘贴AppID'}, {id:'app_secret', label:'AppSecret', placeholder:'粘贴密钥'}] },
  { key: 'dingtalk', label: '钉钉', icon: 'dingtalk-icon', desc: '钉钉机器人，Client ID + Secret', hl: '钉钉开发者后台→创建机器人→填ID和密钥→发布', fields: [{id:'client_id', label:'Client ID', placeholder:'粘贴Client ID'}, {id:'client_secret', label:'Client Secret', placeholder:'粘贴密钥'}] }
];
