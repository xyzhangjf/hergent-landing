...
scp release/Hergent-1.0.76-setup.exe root@47.113.224.140:/var/www/hergent-landing/downloads/

# 3. 上传到更新目录（已安装用户自动更新）
scp release/Hergent-1.0.76-setup.exe root@47.113.224.140:/var/www/hergent-updates/
```
