...
function showDialog(icon, msg, confirmMode) {
  ...
  var cancelBtn = document.getElementById('dialogBtnCancel');
  var okBtn = document.getElementById('dialogBtnOk');
  if (confirmMode) {
    cancelBtn.style.display = '';
    okBtn.textContent = '确定';
    return new Promise(function(resolve) {
      _dialogResolve = resolve;
      okBtn.onclick = function() { hideOverlay('dialogOverlay'); _dialogResolve = null; resolve(true); };
      cancelBtn.onclick = function() { hideOverlay('dialogOverlay'); _dialogResolve = null; resolve(false); };
