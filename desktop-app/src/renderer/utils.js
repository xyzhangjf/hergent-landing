...
/**
 * Send a desktop notification if the window is not in focus.
 * @param {string} title
 * @param {string} body
 */
...
/**
 * Convert technical error messages to user-friendly Chinese strings.
 * Supports 11 common error patterns: network, timeout, auth, server errors.
 * @param {Error|{message?:string}|string|null|undefined} e
 * @returns {string}
 */
function friendlyError(e) {
  var err = /** @type {{message?:string}} */ (e || {});
  var msg = err.message || String(e || "");
  ...
  return (e && (/** @type {{message?:string}} */(e)).message) || "未知错误，请重试";
}
