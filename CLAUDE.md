...
> ⚠️ **注意（2026-08-16 更新）**：本文件是**桌面版（Electron）**的旧规范，桌面版已冻结非主产品。
> **当前主产品 = Web 版 hergent.cn + 预报小程序**，接手请先读根目录 **`HANDOFF.md`**（产品现状/代码位置/部署真相/踩坑/待办）。
> 以下是历史桌面版规范，仅当你在改 `desktop-app/` 时参考。
