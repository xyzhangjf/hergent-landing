  ...
  function goHome() {
    ...
    if (document.getElementById('chatHistory').querySelectorAll('.chat-msg').length === 0) {
      ...
      if (!empty) {
        ...
        empty.id = 'chatEmpty';
        empty.innerHTML = '<div class="welcome-area"><div class="welcome-greeting"><span class="welcome-greeting-icon" id="welcomeIcon">☀️</span><span class="welcome-greeting-text" id="welcomeText">下午好</span></div><div class="welcome-intro"><img class="welcome-avatar" id="welcomeAvatar" src="avatar://dami.png" alt="" /><span>我是你的<strong id="welcomeRoleName">大秘</strong>，今天想做什么？</span></div></div><div class="home-scene-cards" id="homeSceneCards"></div>';
